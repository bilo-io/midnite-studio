...
- [x] **E.6** Number: `memory-report.mjs` with 10 sessions open and 1 visible, before and after, in `done.md`.
...
- [x] **F.5** Number: RSS with 8 tabs open, 1 active, after the threshold — before and after; the discarded tabs' renderer processes are gone from `ps`.
