...
| [92 · Agentic execution from Projects](phases/phase-92-agentic-execution-from-projects.md) | 🔄 WIP | — | 8/36 | `██░░░░░░░░` | 22% | C D | E |
...
- ◻ **A** — the fixed target (`bilo-io/midnite-apps`, never the active repo) and `gh-app-issue.ts`'s command construction
- ◻ **B** — the IPC surface: `mstudio:report:submit-issue`, extending the existing `report` bridge group
