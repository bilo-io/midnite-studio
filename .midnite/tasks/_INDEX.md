...
| [90 · Multi-forge integration and account switching](phases/phase-90-multi-forge-integration.md) | 🔄 WIP | — | 79/110 | `███████░░░` | 72% | L | — |
...
- ◻ **L** — the account switcher: the title-bar avatar becomes a dropdown (accounts with provider icon + brand colour, hidden-repos toggle, Add/Manage), a zero-account Add affordance, `forge.switcherPlacement` (titlebar right/left, rail top/bottom, hidden), and chord-free palette commands
