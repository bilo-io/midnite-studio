...
| [44 · Video Studio](phases/phase-44-video-studio.md) | 🔄 WIP | — | 56/64 | `█████████░` | 88% | F H | F (skill-presence check), H (per-item palette entries, screenshots, real e2e pass) |
