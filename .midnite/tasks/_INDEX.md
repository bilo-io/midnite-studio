...
|-------|--------|---------|------|----------|---|--------|--------|
| [84 · Live everywhere, lighter when hidden](phases/phase-84-live-everywhere-lighter-when-hidden.md) | 🔄 WIP | — | 58/68 | `█████████░` | 85% | E F K | — |
| [83 · Third-party apps rail](phases/phase-83-third-party-apps-rail.md) | ✅ DONE | — | 23/25 | `█████████░` | 92% | — | (2 human passes) |
...
- 🔄 **K** — Cascading reveal, everywhere (`useCascadeReveal`, mount/reveal/repo-switch only, file
  ...
  scans Tailwind keyframes) — K.1-K.6 and K.8 landed; K.7's perf number and Changes/Projects/
  Sessions' own cascade wiring outstanding
