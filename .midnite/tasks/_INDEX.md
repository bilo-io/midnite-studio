...
|-------|--------|---------|------|----------|---|--------|--------|
| [54 · An Issues view](phases/phase-54-issues-view.md) | 🔄 WIP | — | 30/45 | `███████░░░` | 67% | E | — |
...
- ✅ **I** ([PR #TBD](https://github.com/bilo-io/midnite-studio/pull/TBD)) — The terminal does not render on the CI runner. The original diagnosis —
