...
| [78 · Whose hands were on the keyboard](phases/phase-78-whose-hands-were-on-the-keyboard.md) | 🔄 WIP | — | 0/32 | `░░░░░░░░░░` | 0% | A B | C D E F |
...
- ◻ **A** — Read the trailers: `Co-Authored-By` and `Midnite-Session` into `LOG_FORMAT` (NUL-delimited, `%x1f` inside) and `CommitSchema`; measured on the 50k fixture.
- ◻ **B** — `classifyProvenance` in `shared`, pure, with an ordered confidence and per-agent `signatures` on the roster; full branch coverage.
