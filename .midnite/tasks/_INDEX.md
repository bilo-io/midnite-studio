...
|-------|--------|---------|------|----------|---|--------|--------|
| [95 · Agentic improvements](phases/phase-95-agentic-improvements.md) | 🔄 WIP | — | 57/76 | `████████░░` | 75% | J | — |
...
with a Retry-remaining that skips whatever already succeeded. J is unblocked now that both H's
session refs and I's canvas have landed, and is the phase's last theme.
