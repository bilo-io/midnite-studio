...
| [67 · The sessions you closed](phases/phase-67-the-sessions-you-closed.md) | 🔄 WIP | x1 | 16/64 | `███░░░░░░░` | 25% | C D E | F |
...
- ◻ **B** — The history channel: three free `mstudio:sessions:*` channels, `Uint8Array` transcripts structured-cloned never base64 (`PtySnapshotResponse`'s shape), and the `register`/`configure` split handlers need because they register at `index.ts:298` and `userData` only resolves at `:371`.
