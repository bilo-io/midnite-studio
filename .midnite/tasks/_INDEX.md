...
- ✅ **A** (PR #155) — The CLI wrapper actually ships: `resources/bin` added to `extraResources`, `afterpack.cjs` re-asserting +x on the copy, and a new `verify-dist.mjs` gate asserting it is present and executable — proven by breaking it twice on purpose.
