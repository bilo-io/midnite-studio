...
- ✅ **A** (PR #TBD) — one activity palette in `shared` (Brand/Rainbow/Ocean/Ember/Mono presets) and one `.activity-glow` family; metallic silver ring for shells; hardcoded status maps onto tokens
