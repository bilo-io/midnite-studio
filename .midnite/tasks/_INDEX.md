...
|-------|--------|---------|------|----------|---|--------|--------|
| [97 · Workflow graph primitives, loops and templates](phases/phase-97-workflow-graph-primitives.md) | 🔄 WIP | — | 16/91 | `██░░░░░░░░` | 18% | C | D E F G H I J K L M |
...
- ✅ **B** — per-edge routing, a `join` node (all/any/allSettled), the error port replaces `skipDownstream` (PR #TBD)
