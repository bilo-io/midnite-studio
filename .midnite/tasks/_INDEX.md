...
|-------|--------|---------|------|----------|---|--------|--------|
| [87 · Knowledge: the graph the repo already has](phases/phase-87-knowledge-graph-panel.md) | 🔄 WIP | — | 0/60 | `░░░░░░░░░░` | 0% | A B C | D E F G |
...
- 🔄 **A** (claimed, worktree `p87-ab`) — `packages/knowledge`: electron-free reader, lean projection, ForceAtlas2, cache keyed on `built_at_commit`
- 🔄 **B** (claimed, worktree `p87-ab`) — the IPC contract in `shared` and the main handler, with layout off the main thread
