...
- ✅ **F** (PR TBD) — "Add to project ▸" for issues, closing the deferral three phases old.
- ✅ **G** (PR TBD) — Two writes and only two: comment, and close/reopen.
