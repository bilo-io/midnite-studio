...
|-------|--------|---------|------|----------|---|--------|--------|
| [95 · Agentic improvements](phases/phase-95-agentic-improvements.md) | 🔄 WIP | — | 30/76 | `████░░░░░░` | 39% | I E | F H J |
...
- ✅ **G** (PR #TBD) — start / stop / `>_` controls on cards and nodes; drag-to-column fires the mapped skill behind an Undo toast
