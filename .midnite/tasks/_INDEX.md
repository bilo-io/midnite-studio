...
|-------|--------|---------|------|----------|---|--------|--------|
| [54 · An Issues view](phases/phase-54-issues-view.md) | 🔄 WIP | — | 8/45 | `██░░░░░░░░` | 18% | C D | E F G |
...
| [44 · Video Studio](phases/phase-44-video-studio.md) | 🔄 WIP | — | 24/64 | `████░░░░░░` | 38% | D F G H | C (before-quit wiring, folded into H), E (output pane, folded into H) |
...
| [38 · Paying off the e2e suite](phases/phase-38-e2e-suite-repair.md) | 🔄 WIP | — | 51/59 | `█████████░` | 86% | G I | H (blocked on I — Theme H's own precondition is `KNOWN_RED` empty) |
