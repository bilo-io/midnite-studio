...
| [78 · Whose hands were on the keyboard](phases/phase-78-whose-hands-were-on-the-keyboard.md) | 🔄 WIP | — | 17/32 | `█████░░░░░` | 53% | D | E F |
...
- ◻ **C** — The mark on the graph row and in commit detail; an All/Humans/Agents filter that dims, never hides; *probably* in the tooltip for the window join.
- ◻ **D** — Sessions ↔ commits: "N commits" per closed session → the graph narrowed to them → a commit's Provenance line → the archived transcript.
