...
|-------|--------|---------|------|----------|---|--------|--------|
| [79 · The companion that answers back](phases/phase-79-the-companion-that-answers-back.md) | 🔄 WIP | — | 27/67 | `████░░░░░░` | 40% | D E F G | — |
...
- ✅ **C** — The panel: a sibling right-docked resizable column left of Loops, a `PanelStack` thread, a docked textarea with mic + send, a `C` leaf in the quick-access menu, chord-free `companion.toggle`. ([PR #PRNUM](https://github.com/bilo-io/midnite-studio/pull/PRNUM))
...
- ✅ **H** — FAB choreography (`data-companion-state`: listening / thinking / handoff / speaking, reduced-motion statics), the assistant popover as a mini transcript, Settings ▸ Companion, one Playwright spec. ([PR #PRNUM](https://github.com/bilo-io/midnite-studio/pull/PRNUM))
