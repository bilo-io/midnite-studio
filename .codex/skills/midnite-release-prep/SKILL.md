...
**Invoke with:** [major | minor | patch | ephemeral]   (optional — override the auto-detected bump, or prepare an ephemeral test release)
...
Before writing anything, **a direct question to the user** to confirm the proposed version and
surface ambiguity:
