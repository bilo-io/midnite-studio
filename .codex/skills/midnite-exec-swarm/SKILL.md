...
inherits its own rules (`AGENTS.md` conventions, the `.midnite/tasks/` tracker, worktree-per-batch,
...
Each tick, post **one table and nothing else above it** — this is `AGENTS.md`'s own "Sitrep"
