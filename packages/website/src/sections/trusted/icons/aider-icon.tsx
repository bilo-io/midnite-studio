 ...
 *
 * **Provenance.** Original artwork — a stylised Aider "A" terminal
 * pair-programmer mark, drawn for this project. The upstream project ships no
 * square logo. Same file as the desktop app's, copied rather than imported.
 */
