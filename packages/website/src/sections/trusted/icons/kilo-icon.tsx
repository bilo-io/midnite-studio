...
/**
 * Kilo Code's mark, as a local SVG.
 *
 * **Provenance.** Official mono mark published by LobeHub (@lobehub/icons),
 * CC-BY-4.0 / MIT — the same artwork the desktop app renders, copied rather than
 * imported because the marketing site shares no runtime with the app.
 * Nominative mark for the Kilo Code CLI.
 */
export function KiloIcon({
  className,
  style,
}: {
  className?: string;
