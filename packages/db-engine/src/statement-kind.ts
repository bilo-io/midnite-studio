import type { StatementKind } from '@midnite/studio-shared';

/**
 * The `StatementKind` sniffer — shared by Theme I's confirm gate and Theme
 * F's editability checks (neither built in this batch, but both consume this
 * module once they land).
 *
