...
describe('NodePalette', () => {
  ...
  it('lists every node kind by default', () => {
    ...
    // Phase 97 Theme B's `join`, Phase 97 Theme D's `gate`, Phase 97 Theme F's
    // `router`, and Phase 97 Theme E's `verify`.
    expect(screen.getByRole('list', { name: 'Node types' }).querySelectorAll('[role="listitem"]')).toHaveLength(11);
  });
