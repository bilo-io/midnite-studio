...
/**
 * Google Calendar's mark, as a local SVG.
 *
 * **Provenance.** Downloaded from
 * [svgrepo.com](https://www.svgrepo.com/vectors/google-calendar/) — a
 * third-party icon aggregator whose per-upload licence was not confirmed at
 * the time this landed, so treat it the same way as `youtube-icon.tsx`'s
 * mark: a trademark asset reproduced nominatively to name the app this app
 * rail icon launches, not a CC0/MIT one. Confirm svgrepo's stated licence for
 * this specific icon before relying on that distinction for anything more
 * than nominative use. This replaces `react-icons/si`'s monochrome
 * `SiGooglecalendar` — the Phase 83 app rail's original placeholder — with
 * the real multi-colour grid mark.
 *
