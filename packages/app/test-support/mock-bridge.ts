      ...
      list: async () => ({
        agents: [
          ...
          },
          {
            ...
            accent: '#0066FF',
            icon: 'SiCursor',
            install: 'curl -fsSL https://cursor.com/install.sh | bash',
            update: 'agent update',
          ...
          },
          {
            ...
            args: [],
            accent: '#8B5CF6',
            install: 'npm i -g openclaude',
            update: 'npm update -g openclaude',
        ...
        status: [
          ...
          { id: 'cursor', installed: true, resolvedPath: '/usr/local/bin/agent', version: '2026.09.10' },
