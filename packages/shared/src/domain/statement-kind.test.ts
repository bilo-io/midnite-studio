...
/**
 * Moved here from `packages/db-engine/src/statement-kind.test.ts` (Phase 61
 * Theme I) along with the implementation — see that module's docstring.
 * `db-engine`'s own test file now only smoke-tests the re-export.
 */
