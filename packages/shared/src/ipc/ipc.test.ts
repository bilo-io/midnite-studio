  ...
  */
  it('covers every workflow and demo-api channel', () => {
    const expected: Record<string, string[]> = {
      ...
      workflowTemplatesList: ['WorkflowTemplatesListResponse'],
      workflowTemplateSave: ['WorkflowTemplateSaveRequest', 'WorkflowTemplateSaveResponse'],
      workflowTemplateDelete: ['WorkflowTemplateDeleteRequest', 'WorkflowTemplateDeleteResponse'],
