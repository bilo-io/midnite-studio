...
second. This is what the FAB's **Patrol** and **Medic** tabs run when *Triage only* is
checked: look, tabulate, touch nothing.
...
| --- | --- | :-: | :-: | :-: | :-: | :-: | --- |
| [#123](https://github.com/o/r/pull/123) | feat(fab): … | 👤 | ✅ | 👍 | 🟢 | 🕐 1d | +82/−14 |
