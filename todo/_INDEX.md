...
|-------|--------|---------|------|----------|---|--------|--------|
| [29 · Markdown slides, everywhere markdown already renders](phase-29-markdown-slides-viewer.md) | 🔄 WIP | — | 0/21 | `░░░░░░░░░░` | 0% | A–D | E |
...
- ◻ **A** — the deck engine: a headings-only tokenizer (`deck-parser.ts`) ported from midnite's
  `markdownToDeck` — h1 is a cover slide, every h2–h6 starts a new slide, steps render as real
  `react-markdown` fragments rather than midnite's hand-rolled `dangerouslySetInnerHTML`.
- ◻ **B** — the deck presenter: typewriter title + step-by-step bullet reveal, the full keyboard set
  (arrows/space/Home/End/`?`/Escape), a slide-position rail, a help overlay, shiki for code fences.
